...
const Header: React.FC = () => {
  return (
    <header className="p-3 sm:p-4 lg:p-6 flex flex-col items-center justify-center text-center bg-black bg-opacity-30">
      <img src={LOGO_URL} alt="Rádio 520 Logo" className="h-14 sm:h-16 md:h-20 lg:h-24 w-auto mb-2 md:mb-4" />
